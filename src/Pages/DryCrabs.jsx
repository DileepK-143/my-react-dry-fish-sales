...
const crabs = products.filter(
  (product) => product.category.toLowerCase() === "crab"
);
...
const loadProducts = async () => {
 ...
 const filteredItems = crabs.filter((item) =>
  item.name
    .toLowerCase()
  ...
  return (
    <div className="prawns-page">
      ...
      <div className="hero-section">
        <h1 className="main-title">🦀 Premium Dry Crabs</h1>
  ...
  >
    ...
    <option value="1001-1500">
      ₹1001 - ₹1500
        ...
        <p className="tagline">Direct From Kakinada Coast</p>
